          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1 bg-gradient-to-br from-gray-100 to-gray-200 p-8 rounded-2xl shadow-lg border border-gray-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                    <span className="inline-block w-8 h-8 rounded-full bg-gray-600 text-white flex items-center justify-center mr-3">1</span>
                    Assessment previo
                  </h3>
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-100 to-gray-200 p-8 rounded-2xl shadow-lg border border-gray-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                    <span className="inline-block w-8 h-8 rounded-full bg-gray-600 text-white flex items-center justify-center mr-3">2</span>
              ...
              <div className="mt-8 bg-gradient-to-br from-gray-100 to-gray-200 p-8 rounded-2xl shadow-lg border border-gray-200">
                <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center">
                  <span className="inline-block w-8 h-8 rounded-full bg-gray-600 text-white flex items-center justify-center mr-3">3</span>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mt-10">
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200">
