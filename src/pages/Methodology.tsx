    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-neutral via-white to-gray-100">
      ...
      <section className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-black mb-8 text-primary-black leading-tight">
              <span className="block">Metodología OPT</span>
              <span className="block" style={{ color: '#D2AA52' }}>que transforma</span>
            </h1>
            <p className="text-2xl md:text-3xl font-semibold text-secondary-gray mb-10 max-w-4xl mx-auto">
            ...
            {optPhases.map((phase, index) => (
              ...
              >
                <CardHeader className="text-center pb-6">
                  ...
                  <CardTitle className="text-2xl font-bold text-primary-black mb-3">
                    {phase.phase}
                  </CardTitle>
                  <CardDescription className="text-lg text-secondary-gray leading-relaxed">
                    {phase.description}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-primary-black mb-2">Pasos:</h4>
                      <ul className="space-y-1">
                        {phase.steps.map((step, stepIndex) => (
                          <li key={stepIndex} className="flex items-start text-sm text-secondary-gray">
                            <CheckCircle2 className="h-4 w-4 mr-2 mt-0.5 flex-shrink-0" style={{ color: phase.color }} />
                            {step}
                          </li>
                        ))}
                      </ul>
                    ...
                    <div>
                      <h4 className="font-semibold text-primary-black mb-2">Beneficios:</h4>
                      <ul className="space-y-1">
                        {phase.benefits.map((benefit, benefitIndex) => (
                          <li key={benefitIndex} className="flex items-start text-sm text-secondary-gray">
                            <Star className="h-4 w-4 mr-2 mt-0.5 flex-shrink-0" style={{ color: phase.color }} />
                            {benefit}
                          </li>
                        ))}
                      </ul>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center shadow-lg bg-opt-organizacion">
                  <Target className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-xl font-bold text-primary-black mb-3">1. Diagnóstico</h3>
                <p className="text-secondary-gray">Evaluamos tu situación actual en las tres áreas OPT</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center shadow-lg bg-opt-procesos">
                  <Lightbulb className="h-10 w-10 text-gray-800" />
                </div>
                <h3 className="text-xl font-bold text-primary-black mb-3">2. Estrategia</h3>
                <p className="text-secondary-gray">Desarrollamos un plan personalizado de implementación</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center shadow-lg bg-opt-tecnologias">
                  <Zap className="h-10 w-10 text-gray-800" />
                </div>
                <h3 className="text-xl font-bold text-primary-black mb-3">3. Implementación</h3>
                <p className="text-secondary-gray">Ejecutamos las mejoras de forma ágil y controlada</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center shadow-lg bg-opt-organizacion">
                  <Award className="h-10 w-10 text-white" />
                </div>
                <h3 className="text-xl font-bold text-primary-black mb-3">4. Optimización</h3>
                <p className="text-secondary-gray">Medimos resultados y refinamos continuamente</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-sm font-semibold" style={{ color: study.color }}>
                    {study.industry}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-primary-black mb-1">Desafío:</h4>
                    <p className="text-sm text-secondary-gray">{study.challenge}</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-primary-black mb-1">Solución:</h4>
                    <p className="text-sm text-secondary-gray">{study.solution}</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-primary-black mb-1">Resultados:</h4>
                    <p className="text-sm text-secondary-gray font-semibold">{study.results}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="py-20 bg-primary-neutral">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-xl md:text-2xl text-secondary-gray mb-12 max-w-3xl mx-auto">
